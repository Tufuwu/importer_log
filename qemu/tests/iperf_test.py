...
def run(test, params, env):
    ...
    if os_type == 'linux':
        ...
        guest_iperf__bin = iperf_compile(
            guest_iperf_src_path, tmp_dir, guest_session)
    else:
    ...
    if params.get("iperf_server") == params["main_vm"]:
        ...
        s_info = [search_pattern[os_type], s_ip,
                  guest_session, guest_iperf__bin]
        ...
        c_info = [search_pattern[os_type], guest_ip_addr,
                  guest_session, guest_iperf__bin]
