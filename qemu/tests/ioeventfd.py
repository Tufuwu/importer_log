...
def run(test, params, env):
    ...
    def _dd_test(session):
        ...
        logging.debug(session.cmd(
            params['dd_cmd'], float(params['stress_timeout'])))
    ...
    def _iozone_test(session):
        ...
        try:
            iozone.run(params['iozone_options'],
    ...
    for ioeventfd in ioeventfds:
        ...
        error_context.context('Boot a guest with "%s".' %
                              ioeventfd, logging.info)
